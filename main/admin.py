...
from .models import Subscriber, Slider, Slogan,Services, News, Feedbacks, Partners, Video, Info, MediaPartners
...
@admin.register(MediaPartners)
class MEdiaPartnersAdmin(admin.ModelAdmin):
    list_display = ('preview', 'title','url', 'created_at')
    list_display_links = ('preview', 'title')
    readonly_fields = ('created_at',)
    ordering = ('-created_at',)
